...
[1] 서울특별시 '희망두배 청년통장'
희망두배 청년통장은 학자금 대출과 주거비, 비정규직 일자리 등으로 목돈 마련이 어려운 근로 청년을 돕는 서울시 자산형성 사업이다. 운영은 서울시와 서울사회복지공동모금회, 서울시복지재단이 함께 맡는다. 서울시는 2026년 신규 참가자 1만 명을 모집하며, 신청 접수는 6월 8일(월)부터 6월 19일(금)까지 서울시 자산형성지원사업 누리집(account.welfare.seoul.kr)에서 온라인으로 받는다. 최종 선정자는 11월 3일(화) 발표하고 저축은 11월부터 시작한다.
...
[공통점과 차이]
두 사업 모두 본인이 매월 실제로 저축해야 공공기관이 같은 금액 이상을 얹어 주는 매칭형 자산형성 지원이라는 점이 같다. 다만 적용 범위와 조건이 다르다. 희망두배는 서울에 사는 만 18~34세 근로 청년이 서울시 예산으로 본인과 같은 금액인 월 15만 원을 매칭받고, 청년내일저축계좌는 전국에서 가구 소득이 기준 중위소득 50% 이하인 일하는 청년이 정부 예산으로 본인 저축액(월 10만 원 이상)보다 큰 월 30만 원을 지원받는다. 3년을 채웠을 때 받는 금액은 희망두배가 1,080만 원, 청년내일저축계좌가 1,440만 원이며, 여기에 각각 이자가 붙는다. 신규 모집 시기도 희망두배는 6월, 청년내일저축계좌는 5월로 달라 각 사업의 일정에 맞춰 신청해야 한다. 자격 요건도 갈린다. 희망두배는 서울 거주와 부양의무자(부모·배우자)의 소득·재산 기준을 따지고, 청년내일저축계좌는 가구의 기준 중위소득 50% 이하 여부를 본다. 신청 창구도 희망두배는 서울시 자산형성지원사업 누리집, 청년내일저축계좌는 복지로와 행정복지센터로 서로 다르다.`,
} as const;
