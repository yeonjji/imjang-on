...
[시세·전세가율] 선순위 채권최고액(실채무보다 크게 설정. 비율을 정한 법령은 없고 금융회사 내규 사항 — 예: 한국주택금융공사 보금자리론 업무처리기준 '대출 원금의 110% 이상')+보증금 합이 매매시세의 70~80% 초과 시 깡통전세 위험. 시세는 국토부 실거래가(rt.molit.go.kr)·KB시세·부동산테크·안심전세앱 교차확인. 안심전세앱 자가진단·집주인 보증사고/체납/악성임대인 조회(2025-05-27부터 임대인 동의 불요). (국토부·HUG)
[세금·보증] 미납국세는 보증금 1천만원 초과 계약이면 계약 체결 후 임대차 개시일까지 임대인 동의 없이 전국 세무서 열람(국세징수법 제109조 제2항, 2023-04-01 시행). 개시일 다음날부터는 열람 불가, 열람 사실은 임대인에게 통지. 당해세는 국세기본법 제35조 제7항(2023-04-01 시행)으로 확정일자보다 법정기일이 늦은 상속세·증여세·종부세가 임차보증금에 배당 순서를 양보(양보액은 그 당해세 징수액 한도, 선순위 저당권 배당액에는 영향 없음). HUG 반환보증은 보증금이 공시가격 126%(공시가 140%×전세가율 90%) 이내여야 가입, 한도 수도권 7억·비수도권 5억.
...
근저당 채권최고액(실제 대출 원금보다 크게 설정되며, 그 비율은 법령이 아니라 금융회사 내규로 정해집니다)과 내 보증금의 합이 매매 시세의 70~80%를 넘으면 깡통전세 위험이 큽니다. 집이 경매로 넘어가면 보증금을 돌려받기 어렵습니다. 시세는 한 곳만 믿지 말고 국토교통부 실거래가(rt.molit.go.kr), KB시세, 한국부동산원 부동산테크, HUG 안심전세앱을 교차 확인합니다. 안심전세앱은 선순위 채권과 보증금을 입력하면 깡통전세 자가진단을 제공하고, 집주인의 보증사고 이력·세금 체납·악성임대인 등록 여부도 조회됩니다(2025년 5월부터 임대인 동의 없이 조회).

## 3. 세금 체납과 보증가입 여부 확인

임대인이 안 낸 세금 중 법정기일이 내 확정일자보다 빠른 것은 보증금보다 먼저 배당됩니다. 확정일자보다 법정기일이 늦은 당해세(상속세·증여세·종합부동산세)는 2023년 4월 1일부터 보증금에 배당 순서를 양보하지만, 양보되는 금액은 그 당해세로 징수했을 금액이 한도입니다(국세기본법 제35조 제7항). 보증금이 1천만 원을 넘는 계약은 계약을 체결한 뒤 임대차가 시작되는 날까지 임대인 동의 없이도 전국 세무서에서 미납국세를 열람할 수 있습니다(그 이후에는 열람할 수 없고, 열람 사실은 임대인에게 통지됩니다). 또한 HUG 전세보증금반환보증은 보증금이 공시가격의 126%(공시가격 140%×전세가율 90%) 이내여야 가입됩니다(한도: 수도권 7억 원·비수도권 5억 원). 가입이 거절되는 매물은 그 자체로 위험 신호이므로, 계약 전 가입 가능 여부부터 확인합니다.
