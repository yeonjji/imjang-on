...
□ 본 청약 및 입주는 추후 별도 공고하며, 사전청약 당첨자는 본 청약 시 자격을 다시 확인한다.`,
  ...
  {
    sourceName: '한국거래소',
    sourceUrl: 'https://www.krx.co.kr/board/example-leverage-etf',
    text: `[한국거래소 보도자료] 2026.6.20.
제목: 코스피200 2배 추종 'OO 레버리지 ETF' 신규 상장

□ 한국거래소는 6월 25일 유가증권시장에 'OO KOSPI200 레버리지 ETF'를 신규 상장한다.
□ 기초지수는 코스피200이며, 기초지수 일일 수익률의 2배를 추종한다.
□ 운용사는 OO자산운용, 총보수는 연 0.45%다.
□ 상장 좌수는 1,000만 좌, 1좌당 기준가격은 10,000원이다.
□ 분배금은 연 1회(매년 12월) 지급할 예정이다.`,
  },
];
