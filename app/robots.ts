...
export default function robots(): MetadataRoute.Robots {
  ...
  // Amazonbot·Applebot-Extended·meta-externalagent는 Cloudflare Managed robots.txt가 차단하던
  // 봇을 흡수한 것. 그 기능을 끄면서 이쪽으로 옮겼다(두 개의 'User-agent: *' 그룹이 생겨,
  // 그룹 병합을 안 하는 파서가 _rsc 차단을 놓치던 문제).
  const blockedBots = [
    'AhrefsBot',
    'SemrushBot',
    'MJ12bot',
