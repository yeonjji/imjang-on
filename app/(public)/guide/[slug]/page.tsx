...
import { AutoGeneratedNotice } from '@/components/ui/auto-generated-notice';
...
import { GuideBody } from '@/app/(public)/guide/[slug]/_components/guide-body';
...
export default async function GuideDetailPage({ params }: Params) {
  ...
  return (
    <article className="mx-auto max-w-[760px] px-6 py-12">
      ...
      <AutoGeneratedNotice className="mt-6" />
      <GuideBody body={rest} />
