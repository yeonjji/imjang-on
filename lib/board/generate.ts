...
7. 각 섹션 본문은 문단 중심의 산문으로 서술한다. 한 섹션 안에서 정보를 잘게 토막내지 말고 문장으로 연결해 읽히게 쓴다. 다만 단지별 접수일·발표일, 항목별 수치, 일정표처럼 열거가 본질이라 독자가 훑어서 찾는 정보는 목록이나 표로 둔다 — 그런 정보를 억지로 산문으로 풀면 오히려 읽기 어려워진다.
