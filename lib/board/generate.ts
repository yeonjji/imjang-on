...
11. 분량은 공백 제외 한글 최소 1,000자(2,000자 안팎). 자료의 고유 사실이 적어 분량이 부족하면, 등장한 제도·상품·용어의 구조와 작동 방식, 적용 대상·일정·절차, 일반적으로 알려진 위험·유의점을 문장으로 풀어 채운다. 단 자료에 없는 구체 수치·고유 사실은 새로 만들지 않는다.
