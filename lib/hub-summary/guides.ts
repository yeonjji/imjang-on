...
const GUIDES: Record<HubGuideKey, string> = {
  ...
  convenience: '편의점 분포는 생활 편의와 상권 활력을 가늠하는 지표입니다. 도보권에 얼마나 있는지와 인근 아파트 시세를 함께 참고해 생활권을 살펴보세요.',
  mart: '대형마트·슈퍼는 장보기 동선과 생활비에 직접 영향을 줍니다. 도보·차량 접근성과 지역별 분포를 함께 확인하세요.',
  cafe: '카페가 얼마나 많은지는 상권 성숙도와 생활 편의를 보여줍니다. 지역별 분포를 참고해 동네 분위기와 생활권을 가늠해 보세요.',
